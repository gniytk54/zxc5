                  ...
                  ctx.drawImage(ground, 0, 0, 400, 200);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '20px';
                              ctx.fillStyle = "#f1f1f1";
      ctx.fillText(`Welcom to Creativity Community`, 260, 125);
...
if (message.content.startsWith('G.users')){
 if(!message.author.id === '486141054677155860') return;
...
if (message.author.id !== '486141054677155860') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
...
client.on('guildMemberAdd', member => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField('Hello Dude' , `Welcome to Creativity Community**${member}**`)
